...
export default function Page() {
  return (
    <div>
      <PageHeader title="Hồ sơ học viên" description="Xem và quản lý hồ sơ học viên" />
      <div className="mt-6 rounded-2xl bg-surface-container-low border border-outline-variant/30 p-8 text-center">
        <span className="material-symbols-outlined text-[48px] text-outline mb-3 block">badge</span>
