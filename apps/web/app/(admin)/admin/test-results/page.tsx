...
export default function AdminTestResultsPage() {
  ...
  return (
    <div>
      <PageHeader title="Kết quả thi & Đánh giá" description="Lịch sử làm bài thi thử, điểm số và kết quả đạt chuẩn của học viên" />
              ...
              {loading ? (
                ...
                <tr>
                  <td colSpan={7} className="py-16 text-center">
                    ...
                    <p className="text-on-surface-variant text-sm">Chưa có lượt nộp bài thi nào</p>
                  </td>
                </tr>
              ) : (
                results.map((r) => (
