...
export default function Page() {
  return (
    <div>
      <PageHeader title="Chi tiết báo cáo" description="Báo cáo chi tiết theo tiêu chí" />
      <div className="mt-6 rounded-2xl bg-surface-container-low border border-outline-variant/30 p-8 text-center">
        <span className="material-symbols-outlined text-[48px] text-outline mb-3 block">bar_chart</span>
