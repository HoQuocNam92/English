...
export default function TeacherStudentsPage() {
  ...
  return (
    <div>
      <PageHeader title="Học viên của tôi" description="Danh sách học viên tham gia các lớp và lộ trình bạn giảng dạy" />
          ...
          students.map((st) => (
            ...
            >
              ...
              <div className="mt-4 pt-3 border-t border-outline-variant/20 flex items-center justify-between text-xs text-on-surface-variant">
                ...
                <span className="text-secondary font-medium text-[11px] bg-secondary/5 px-2 py-0.5 rounded">Học viên IT</span>
              </div>
            </div>
          ))
        )}
