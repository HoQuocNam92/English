...
interface ModalProps {
  ...
  maxWidth?: string;
  /** Optional custom CSS width, e.g. 'min(64rem, calc(100vw - 32px))' */
  widthStyle?: string;
}
 ...
 */
export function Modal({ open, onClose, children, maxWidth = 'max-w-lg', widthStyle }: ModalProps) {
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          top: '50%',
          left: '50%',
          width: widthStyle ?? 'min(42rem, calc(100vw - 32px))',
          maxWidth: 'none',
